...
#if defined(OPENSCAP_PROBE_INDEPENDENT_ENVIRONMENTVARIABLE) || defined(OPENSCAP_PROBE_EXT_INDEPENDENT_ENVIRONMENTVARIABLE)
...
#if defined(OPENSCAP_PROBE_INDEPENDENT_SYSTEM_INFO) || defined(OPENSCAP_PROBE_EXT_INDEPENDENT_SYSTEM_INFO)
...
#if defined(OPENSCAP_PROBE_INDEPENDENT_VARIABLE) || defined(OPENSCAP_PROBE_EXT_INDEPENDENT_VARIABLE)
