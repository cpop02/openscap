...
static oval_syschar_collection_flag_t _flag_agg_map[8][8] = {
        ...
        {SYSCHAR_FLAG_UNKNOWN, SYSCHAR_FLAG_ERROR,
                ...
                SYSCHAR_FLAG_NOT_APPLICABLE, SYSCHAR_FLAG_PENDING_COLLECT},
        ...
        {SYSCHAR_FLAG_DOES_NOT_EXIST, SYSCHAR_FLAG_ERROR,
                ...
                SYSCHAR_FLAG_DOES_NOT_EXIST, SYSCHAR_FLAG_NOT_COLLECTED,
                SYSCHAR_FLAG_NOT_APPLICABLE, SYSCHAR_FLAG_DOES_NOT_EXIST},
        ...
        {SYSCHAR_FLAG_NOT_COLLECTED, SYSCHAR_FLAG_ERROR,
                ...
                SYSCHAR_FLAG_NOT_COLLECTED, SYSCHAR_FLAG_NOT_COLLECTED,
                SYSCHAR_FLAG_NOT_APPLICABLE, SYSCHAR_FLAG_NOT_COLLECTED},
        ...
        // SYSCHAR_FLAG_PENDING_COLLECT
        {SYSCHAR_FLAG_PENDING_COLLECT, SYSCHAR_FLAG_ERROR,
                SYSCHAR_FLAG_PENDING_COLLECT, SYSCHAR_FLAG_PENDING_COLLECT,
                SYSCHAR_FLAG_PENDING_COLLECT, SYSCHAR_FLAG_PENDING_COLLECT,
                SYSCHAR_FLAG_NOT_APPLICABLE, SYSCHAR_FLAG_PENDING_COLLECT},
};
...
static void _oval_component_clone_subcomponents
        (struct oval_component *old_component, struct oval_component *new_component,
         struct oval_definition_model *model)
{
...
xmlNode *oval_component_to_dom(struct oval_component *component, xmlDoc *doc, xmlNode *parent)
{
    ...
    const char *local_name = type < OVAL_FUNCTION
                             ? _OVAL_COMPONENT_MAP[type - 1].string : _OVAL_FUNCTION_MAP[type - OVAL_FUNCTION -
                                                                                         1].string;
            ...
            while (oval_sysent_iterator_has_more(sysent_itr)) {
                ...
                if (dt != OVAL_DATATYPE_RECORD && rfield_name != NULL) {
                    oscap_seterr(OSCAP_EFAMILY_OVAL,
                                 ...
                                 oval_datatype_get_text(dt), ifield_name, oval_sysitem_subtype, oval_sysitem_id,
                                 obj_id);
                    oval_sysent_iterator_free(sysent_itr);
                    oval_sysitem_iterator_free(sysitems);
                    return SYSCHAR_FLAG_ERROR;
...
static oval_syschar_collection_flag_t
_oval_component_evaluate_ARITHMETIC_rec(struct val_col_lst_s *val_col_lst, double val,
